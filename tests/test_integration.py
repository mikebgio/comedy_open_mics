...
def test_full_user_journey(client):
    ...
    response = client.post('/host/create_event', data={
    ...
    response = client.post(f'/comedian/signup/{event_id}', data={
        'notes': 'Excited to perform my new set!'
    }, follow_redirects=True)
...
def test_event_management_workflow(client):
    ...
    # Create event
    client.post('/host/create_event', data={
        'name': 'Test Event',
        'venue': 'Test Venue',
...
def test_api_endpoints(client):
    ...
    response = client.post(f'/host/reorder_lineup/{event_id}', 
                          json={'lineup_order': []},
